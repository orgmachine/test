...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-summary-summary-module"], {
  ...
  function srcAppPagesSummarySummaryPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function SummaryPage(router, route, navCtrl, api, util) {
      ...
      _createClass(SummaryPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {// this.route.queryParams.subscribe(data => {
          // 	console.log(data)
          //    if (data && data.from) {
          //      this.data = data;
          //      this.from = data.from;
