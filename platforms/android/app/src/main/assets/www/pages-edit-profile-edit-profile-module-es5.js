...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-edit-profile-edit-profile-module"], {
  ...
  function srcAppPagesEditProfileEditProfileModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    EditProfilePageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _edit_profile_routing_module__WEBPACK_IMPORTED_MODULE_5__["EditProfilePageRoutingModule"], src_app_components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"]],
  ...
  function srcAppPagesEditProfileEditProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function EditProfilePage(camera, sheetCtrl, api, util, menu) {
      ...
      _createClass(EditProfilePage, [{
        ...
        value: function getCamera() {
          ...
          this.camera.getPicture(options).then(function (file_uri) {
            _this3.image = "data:image/jpg;base64," + file_uri;
            _this3.imagePreview = file_uri;
            _this3.isImgChange = true;
            var data = {
              image: _this3.imagePreview
            };
            ...
            firebase__WEBPACK_IMPORTED_MODULE_6__["storage"]().ref().child(sessionStorage.getItem('uid')).child(btoa(id) + '.jpg').putString(_this3.image, 'data_url').then(function (snapshot) {
              _this3.util.hide();
              ...
              snapshot.ref.getDownloadURL().then(function (url) {
                ...
                _this3.api.updateProfile(uid, param).then(function (data) {
                  console.log(data); // this.ngOnInit();

                  _this3.util.showToast('Profile updated successfully', 'primary', 'bottom');
                }).catch(function (err) {
                  if (err) {
                    console.log(err);
        ...
        value: function getGallery() {
          ...
          this.camera.getPicture(options).then(function (file_uri) {
            _this4.image = "data:image/jpg;base64," + file_uri;
            _this4.imagePreview = file_uri;
            _this4.isImgChange = true;
            var data = {
              image: _this4.imagePreview
            };

            _this4.util.show();

            var id = sessionStorage.getItem('uid') + '/' + _this4.util.makeid(10);

            firebase__WEBPACK_IMPORTED_MODULE_6__["storage"]().ref().child(sessionStorage.getItem('uid')).child(btoa(id) + '.jpg').putString(_this4.image, 'data_url').then(function (snapshot) {
              _this4.util.hide();
              ...
              snapshot.ref.getDownloadURL().then(function (url) {
                ...
                _this4.api.updateProfile(uid, param).then(function (data) {
                  console.log(data);

                  _this4.ngOnInit();

                  _this4.util.showToast('Profile updated successfully', 'primary', 'bottom');
                }).catch(function (err) {
                  if (err) {
                    console.log(err);
        ...
        value: function changeProfile() {
          ...
          this.api.updateProfile(uid, param).then(function (data) {
            ...
            _this5.util.showToast('Profile has updated successfully', 'primary', 'bottom');
        ...
        value: function _handleReaderLoaded(readerEvt) {
          ...
          firebase__WEBPACK_IMPORTED_MODULE_6__["storage"]().ref().child(sessionStorage.getItem('uid')).child(btoa(id) + '.jpg').putString(base64Image, 'data_url').then(function (snapshot) {
            snapshot.ref.getDownloadURL().then(function (url) {
              _this6.util.hide();
              ...
              var modifiedOn = moment__WEBPACK_IMPORTED_MODULE_7__(date).format("YYYY-MM-DD hh:mm:ss A");
              var id = Math.floor(100000000 + Math.random() * 900000000);
              _this6.profile.imagePath = url;
              _this6.headerImage = url;
              var param = {
                modifiedOn: modifiedOn,
                imagePath: url
              };
              ...
              _this6.api.updateProfile(uid, param).then(function (data) {
                console.log(data);

                _this6.ngOnInit();

                _this6.util.showToast('Profile updated successfully', 'primary', 'bottom');
              }).catch(function (err) {
                if (err) {
                  console.log(err);
