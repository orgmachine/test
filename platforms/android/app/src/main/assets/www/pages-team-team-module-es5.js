...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-team-team-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTeamTeamPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTeamTeamPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTeamTeamPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TeamPage = function TeamPage(route, router, alertCtrl, menu, api) {
      var _this = this;
      ...
      this.api.getTeamMemberById(id).then(function (data) {
        _this.team_member = data[0];
        console.log(_this.team_member);
